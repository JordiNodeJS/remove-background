  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[var(--background)] px-4">
      <header className="w-full max-w-md flex flex-col items-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-[var(--primary)] mb-1 tracking-tight">Recupera tu contraseña</h1>
        <p className="text-[var(--muted)] text-base text-center">Ingresa tu correo para recibir instrucciones de recuperación</p>
      </header>
