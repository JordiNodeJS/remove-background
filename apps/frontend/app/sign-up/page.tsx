  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[var(--background)] px-4">
      <header className="w-full max-w-md flex flex-col items-center mb-8">
        <Image src="/favicon.svg" alt="Logo" width={56} height={56} className="mb-2" />
        <h1 className="text-3xl font-bold text-[var(--primary)] mb-1 tracking-tight">Crea tu cuenta</h1>
        <p className="text-[var(--muted)] text-base text-center">Regístrate para comenzar a eliminar fondos de imágenes</p>
      </header>
        ...
        <SignUp
          ...
          appearance={{
            elements: {
              ...
              footerActionLink: 'underline text-[var(--primary)] hover:text-[var(--primary-hover)]',
            },
          }}
          routing="path"
          signInUrl="/"
